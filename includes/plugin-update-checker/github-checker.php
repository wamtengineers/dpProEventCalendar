...
if ( !class_exists('PucGitHubChecker_2_2_custom', false) ):

class PucGitHubChecker_2_2_custom extends PluginUpdateChecker_2_2_custom {
	/**
	...
	public function requestInfo($unusedQueryArgs = array()) {
		$info = new PluginInfo_2_2_custom();
	...
	/**
	 * Copy plugin metadata from a file header to a PluginInfoCustom object.
	 *
	 * @param array $fileHeader
	 * @param PluginInfo_2_2_custom $pluginInfo
	 */

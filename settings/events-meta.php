...
function dpProEventCalendar_events_display( $post ) {
	...
	if(isset($_GET['action']) && $_GET['action'] == 'edit') {
		// Ocultamos esta sección
	?>
	<p class="misc-pub-section" style="display: none">
		...
		<!-- <div class="clear"></div> -->
	<?php }
	// Abrimos un div, para ocultar la sección
	?>
	...
	<?php
		// Aqui se cierra el div, y se excluye el link
	?>
	<p class="misc-pub-section">
	...
	<?php
		// Volvemos a abrir un div oculto, para no mostrar la siguiente sección
	?>
	<div style="display: none;">
		<p class="misc-pub-section">
...
function dpProEventCalendar_booking_display( $post ) {
	...
	<?php
		// Aqui se cierra el div que se ocultó.
	?>
	...
	<div id="pec_new_booking" style="display: none;">
		...
		<!-- <div class="clear"></div> -->
		<div class="misc-pub-section" style="display: none;">
		...
		<div class="misc-pub-section" style="display: none;">
			...
			<select name="pec_new_booking_status" id="pec_new_booking_status">
				<option value=""><?php echo __( 'Inscrito', 'dpProEventCalendar' )?></option>
				<option value="asistio"><?php echo __( 'Asistio', 'dpProEventCalendar' )?></option>
	...
	<a class="button" href="javascript:void(0);" data-dppec-eventid="<?php echo $post->ID?>" id="pec_booking_filter"><?php _e('Filter', 'dpProEventCalendar'); ?></a>
		<a class="button button-primary" style="float: right; margin-left: 10px;" id="all_pec_booking_status_apply" onclick="pec_changeAllStatusBookins(<?php echo $post->ID; ?>, event);"><?php _e('Apply to all', 'dpProEventCalendar'); ?></a>
		<select id="all_pec_booking_status" style="float: right;">
			<option value=""><?php echo __( 'Inscrito', 'dpProEventCalendar' )?></option>
			<option value="asistio"><?php echo __( 'Asistio', 'dpProEventCalendar' )?></option>
		</select>
	<hr>
	...
	<table class="widefat pec_booking_table" cellpadding="0" cellspacing="0" id="pec-sort-table">
		...
		<tbody id="pec-booking-list" data-idevent="<?php echo $id_list; ?>">
			<?php
			...
			<tr>
				...
				<td>
					<select name="pec_booking_status[<?php echo $booking->id?>]" onchange="pec_change_booking_status('<?php echo $booking->status?>', this);">
						<option value=""  <?php if($booking->status == "") {?> selected="selected" <?php }?>><?php echo __( 'Inscrito', 'dpProEventCalendar' )?></option>
						<option value="asistio" <?php if($booking->status == "asistio") {?> selected="selected" <?php }?>><?php echo __( 'Asistio', 'dpProEventCalendar' )?></option>
					...
					<a class="button button-primary" style="margin-left: 5px;" id="cur_pec_booking_status_update" onclick="pec_changeCurrentBooking(<?php echo $booking->id; ?>, event);"><span style="line-height: 26px; font-size: 18px;" class="dashicons dashicons-image-rotate"></span></a>
